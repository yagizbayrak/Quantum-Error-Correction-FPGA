...
entity recurrent_fifo_w14_d2_S is 
    generic (
...
architecture rtl of recurrent_fifo_w14_d2_S is
...
------------------------Component----------------------
    component recurrent_fifo_w14_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 14;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_recurrent_fifo_w14_d2_S_ShiftReg : recurrent_fifo_w14_d2_S_ShiftReg
    generic map (
...
entity recurrent_fifo_w14_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 14;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end recurrent_fifo_w14_d2_S_ShiftReg;

architecture rtl of recurrent_fifo_w14_d2_S_ShiftReg is
